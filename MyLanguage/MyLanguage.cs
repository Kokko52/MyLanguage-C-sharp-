        ...
        public void Run()
        {
            try
            {
                ...
                while (lens_code < element.Length)
                {
                    ...
                    //exists brackets '{'
                    if (element[lens_code] == "{" || element[lens_code].Contains('{')) { _sk++; }
                    //exists brackets '}'
                    if (element[lens_code] == "}" || element[lens_code] == "};" || element[lens_code].Contains('}')) { _sk--; }
                    #endregion
                    ++lens_code;
                }
                ...
                m_math_lib:
                    ...
                    if (element[lens_code].Contains("Math.Round"))
                    {
                        ...
                        element[lens_code] = element[lens_code].Replace("Math.Round[" + main + "]", Convert.ToString(value));
                        goto m_math_lib;
                    }
                    //Math.Floor
                    if (element[lens_code].Contains("Math.Floor"))
                    {
                        ...
                        element[lens_code] = element[lens_code].Replace("Math.Floor[" + main + "]", Convert.ToString(value));
                        goto m_math_lib;
                    }
                    //Math.Ceiling
                    if (element[lens_code].Contains("Math.Ceiling"))
                    {
                        ...
                        element[lens_code] = element[lens_code].Replace("Math.Ceiling[" + main + "]", Convert.ToString(value));
                        goto m_math_lib;
                    }
                    //Math.Sign
                    if (element[lens_code].Contains("Math.Sign"))
                    {
                        ...
                        element[lens_code] = element[lens_code].Replace("Math.Sign[" + main + "]", Convert.ToString(value));
                        goto m_math_lib;
                    }
                    //Math.Pow
                    if (element[lens_code].Contains("Math.Pow"))
                    {
                        ...
                        element[lens_code] = element[lens_code].Replace("Math.Pow[" + main + "]", Convert.ToString(value));
                        goto m_math_lib;
                    }
                    //Math.Cos
                    if (element[lens_code].Contains("Math.Cos"))
                    {
                        ...
                        element[lens_code] = element[lens_code].Replace("Math.Cos[" + main + "]", Convert.ToString(value));
                        goto m_math_lib;
                    }
                    //Math.Sinh
                    if (element[lens_code].Contains("Math.Sinh"))
                    {
                        ...
                        element[lens_code] = element[lens_code].Replace("Math.Sinh[" + main + "]", Convert.ToString(value));
                        goto m_math_lib;
                    }
                    //Math.Sin
                    if (element[lens_code].Contains("Math.Sin"))
                    {
                        ...
                        element[lens_code] = element[lens_code].Replace("Math.Sin[" + main + "]", Convert.ToString(value));
                        goto m_math_lib;
                    }
                    //Math.Sqrt
                    if (element[lens_code].Contains("Math.Sqrt"))
                    {
                        ...
                        element[lens_code] = element[lens_code].Replace("Math.Sqrt[" + main + "]", Convert.ToString(value));
                        goto m_math_lib;
                    }
                    #endregion
                    ...
                    for (int i = 0; i < list_func.Count; i++)
                    {
                        ...
                        if (element[lens_code].Contains(list_func.ElementAt(i).Key))
                        {
                            ...
                            func_check = true;
                            //values
                            string func_date = element[lens_code].Replace(list_func.ElementAt(i).Key, "~").Split('~')[1].Split(')')[0].Replace("(", "").Replace(")", "");
                            func func = new func();
                            //name function
                            func.func_name = list_func.ElementAt(i).Key;
                            //values function
                            func.func_value = func_date;
                            func.ch_mn = check_main;
                            func.lens_code = list_func_str[func.func_name];
                            if (!func.run(list_int, list_string, list_double, list_func, otp, element)) { return; }
                    ...
                    if (func_check)
                    {
                        ...
                        catch (ArgumentNullException) { otp.Text = "Syntax invalid: func error"; return; }
                        func_check = false;
                    }
                    //replace
                    if (element[lens_code].Contains("func " + name_func))
                    {
                        ...
                        catch (IndexOutOfRangeException) { otp.Text = "Syntax invalid: function has no return "; return; }
                        try
                        {
                    ...
                    if (element[lens_code].Split(' ')[0] == "kvint")
                    {
                        ...
                        kvint.ch_mn = check_main;
                        kvint.lens_code = lens_code;
                    ...
                    if (list_int.ContainsKey(element[lens_code].Split(' ')[0]))
                    {
                        ...
                        if (!cls.run(element, list_int, element[lens_code].Split(' ')[0], otp)) { return; }
                    ...
                    else if (list_double.ContainsKey(element[lens_code].Split(' ')[0]))
                    {
                        ...
                        if (!cls.run(element, lens_code, list_double, list_int, element[lens_code].Split(' ')[0], otp)) { return; }
                    }
                    //variable - string
                    else if (list_string.ContainsKey(element[lens_code].Split(' ')[0]))
                    {
                        ...
                        cls.lens_code = lens_code;
                        if (!cls.run(element, list_string, element[lens_code].Split(' ')[0], otp)) { return; }
                        lens_code = cls.lens_code;
                    }
                    #endregion
            ...
            catch (Exception) { otp.Text = "Syntax invalid: error";return; }
        }
